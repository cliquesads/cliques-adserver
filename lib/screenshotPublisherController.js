 ...
 *
 * @param {String} creativeGroupId - the creative group id
 * @param {String} clickURL - the website URL that serves the ad
 */
var formPublishingMessageContent = function(creativeGroupId, clickURL) {
    return `crgid=${creativeGroupId}&clickURL=${clickURL}`;
}
 ...
 */
var storeIdPair = exports.storeIdPair = function(placementId, creativeGroupId, clickURL, pubsubService) {
        ...
        if (!reply) {
            ...
            if (elapsed > timeoutSecs * 1000) {
                ...
                if (valueInfo.count >= screenshotLimits) {
                    ...
                    redisConnection.set(keyForIdPair, initiateIdPairValue());
                    pubsubService.publishers.createScreenshot(formPublishingMessageContent(creativeGroupId, clickURL));
                } else {
